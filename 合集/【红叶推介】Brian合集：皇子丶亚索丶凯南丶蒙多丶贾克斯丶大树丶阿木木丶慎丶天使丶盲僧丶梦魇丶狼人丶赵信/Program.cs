...
namespace BrianSharp
{
    ...
    internal class Program
    {
        ...
        private static void OnStart(EventArgs args)
        {
            ...
            MainMenu = new Menu("【红叶推介】Brian合集：", "BrianSharp", true);
            var infoMenu = new Menu("红叶", "Info");
            {
                infoMenu.AddItem(new MenuItem("Author", "L#正版红叶唯一防封官方群 468103641"));
                infoMenu.AddItem(new MenuItem("Paypal", "解决问题来YY44681036！"));
