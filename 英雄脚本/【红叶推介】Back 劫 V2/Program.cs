    ...
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            try
            {
                ...
                _config = new Menu("【红叶推介】Back 劫 V2", "Zed Is Back", true);
                ...
                Game.PrintChat("<font color='#881df2'>銆愮孩鍙舵帹浠嬨€態ack |鍔珅 V2 鍔犺浇鎴愬姛</font>.");
                Game.PrintChat("<font color='#f2881d'>L#鍞竴姝ｇ増绾㈠彾闃插皝瀹樻柟缇 342724614</font>");
