...
namespace Irelia_Reloaded
{
    internal class Program
    {
        ...
        public static void GameOnOnGameLoad(EventArgs args)
        {
            ...
            Game.PrintChat("<font color=\"#7CFC00\"><b>銆愮孩鍙舵帹浠嬨€戙€愮孩鍙舵帹浠嬨€慍hewyMoon |鍒€濡箌 閲嶅仛 鍔犺浇鎴愬姛</b></font> L#鍞竴姝ｇ増绾㈠彾闃插皝瀹樻柟缇 342724614");
        ...
        {
            Menu = new Menu("【红叶推介】ChewyMoon 刀妹 重做", "cmIreliaReloaded", true);
