...
namespace MoonDraven
{
    ...
    internal class MoonDraven
    {
        ...
        public void Load()
        {
            ...
            Game.PrintChat("<font color=\"#7CFC00\"><b>銆愮孩鍙舵帹浠嬨€慍hewyMoon |寰疯幈鏂噟 鍔犺浇鎴愬姛</b></font> L#鍞竴姝ｇ増绾㈠彾闃插皝瀹樻柟缇 342724614");
        ...
        {
            this.Menu = new Menu("【红叶推介】ChewyMoon 德莱文", "cmMoonDraven", true);
