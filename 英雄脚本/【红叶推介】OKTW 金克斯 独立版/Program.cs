...
namespace Jinx
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            SpellList.Add(R);
            SpellList.Add(R1);
            Config = new Menu("【红叶推介】OKTW 金克斯", ChampionName, true);
            ...
            Game.PrintChat("<font color=\"#ff00d8\">Ergou</font>銆愮孩鍙舵帹浠嬨€慜KTW 閲戝厠鏂瘄 鍔犺浇鎴愬姛<font color=\"#000000\">L#鍞竴姝ｇ増绾㈠彾闃插皝瀹樻柟缇 342724614</font> - <font color=\"#00BFFF\"></font>");
        }
