...
namespace KogMaw
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("【红叶推介】OKTW 大嘴", ChampionName, true);
            ...
            Game.PrintChat("<font color=\"#008aff\">K</font>銆愮孩鍙舵帹浠嬨€慜KTW 澶у槾| 鍔犺浇鎴愬姛<font color=\"#000000\">L#鍞竴姝ｇ増绾㈠彾闃插皝瀹樻柟缇 342724614</font> - <font color=\"#00BFFF\">-</font>");
        }
