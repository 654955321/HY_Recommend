...
namespace Olafisback
{
    ...
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            /* [ Menus ] */
            Config = new Menu("【红叶推介】Back 奥拉夫 V2", ChampionName, true);
            ...
            Game.PrintChat("<font color='#FFFFFF'>銆愮孩鍙舵帹浠嬨€態ack |濂ユ媺澶珅 V2 鍔犺浇鎴愬姛</font> <font color='#70DBDB'> L#鍞竴姝ｇ増绾㈠彾闃插皝瀹樻柟缇 342724614</font>");
        }
