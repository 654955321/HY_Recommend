...
namespace jesuisFiora
{
    internal static class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Menu = new Menu("【红叶推介】jesuis 剑姬", "jesuisFiora", true);
            ...
            Game.PrintChat(
                "<font color=\"{0}\">銆愮孩鍙舵帹浠嬨€慾esuis 鍓戝К 鍔犺浇鎴愬姛 L#鍞竴姝ｇ増绾㈠彾闃插皝瀹樻柟缇 342724614!</font>", System.Drawing.Color.DeepPink.ToHexString());
        }
