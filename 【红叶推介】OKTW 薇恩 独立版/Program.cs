...
namespace Vayne_OneKeyToWin
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("【红叶推介】OKTW 薇恩 独立版", ChampionName, true);
            ...
            Game.PrintChat("<font color=\"#7e62cc\">銆愮孩鍙舵帹浠嬨€慜KTW |钖囨仼鐙珛鐗坾 鍔犺浇鎴愬姛</font>-<font color=\"#000000\">L#鍞竴姝ｇ増绾㈠彾闃插皝瀹樻柟缇 342724614</font>");
        }
