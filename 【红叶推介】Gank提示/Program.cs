...
namespace UniversalGankAlerter
{
    internal class Program
    {
        ...
        private void Game_OnGameLoad(EventArgs args)
        {
            ...
            _menu = new Menu("【红叶推介】Gank提示", "universalgankalerter", true);
        ...
        {
            Game.PrintChat(
                "<font color='#ff3232'>銆愮孩鍙舵帹浠嬨€慓ank鎻愮ず鍔犺浇鎴愬姛</font><font color='#d4d4d4'>L#鍞竴姝ｇ増绾㈠彾闃插皝瀹樻柟缇 342724614</font> <font color='#FFFFFF'>" +
                msg + "</font>");
        }
