...
namespace LeagueSharp.Common
{
    ...
    {
        internal static Menu Config = new Menu("【红叶推介】基础库", "LeagueSharp.Common", true);
        ...
        static CommonMenu()
        {
            ...
            Config.AddItem(new MenuItem("flowers1", "正版红叶防封正确开启后:不会追封 异常 非法！"));
            Config.AddItem(new MenuItem("flowers2", "登陆防封点击开启会提示“红叶开启成功，请注意阅读说明"));
            Config.AddItem(new MenuItem("flowers3", "进游戏读条后 防封界面就会显示“处理成功“"));
            Config.AddItem(new MenuItem("flowers4", "游戏结束后 防封必须到”初始化“才是正常，否则等于裸奔"));
            Config.AddItem(new MenuItem("flowers5", "L#唯一正版红叶防封官方群 342724614!"));
			Config.AddItem(new MenuItem("flowers5", "自动发卡地址 http://917ka.com/list/2yu4u"));
    ...
    internal static class MenuSettings
    {
        ...
        {
            get { return Color.FromArgb(70, Color.BlueViolet); }
        }
