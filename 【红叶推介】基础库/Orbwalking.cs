...
namespace LeagueSharp.Common
{
    ...
    public static class Orbwalking
    {
        ...
        private static readonly string[] AttackResets =
        {
            ...
            "xinzhaocombotarget", "yorickspectral", "reksaiq", "itemtitanichydracleave"
        };
        ...
        public class Orbwalker
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                _config.AddItem(new MenuItem("FarmDelay", "打钱延迟").SetShared().SetValue(new Slider(7, 0, 200)));
                _config.AddItem(
                    new MenuItem("MovementDelay", "移动延迟").SetShared().SetValue(new Slider(36, 0, 250)))
            ...
            private void DrawingOnOnDraw(EventArgs args)
            {
                ...
                {
                    if (Hp百分比(Player) > 60)
                        Render.Circle.DrawCircle(Player.Position, GetRealAutoAttackRange(null) + 65, System.Drawing.Color.GreenYellow, _config.Item("AALineWidth").GetValue<Slider>().Value);
                    else if (Hp百分比(Player) > 30)
                        Render.Circle.DrawCircle(Player.Position, GetRealAutoAttackRange(null) + 65, System.Drawing.Color.Orange, _config.Item("AALineWidth").GetValue<Slider>().Value);
                    else
                        Render.Circle.DrawCircle(Player.Position, GetRealAutoAttackRange(null) + 65, System.Drawing.Color.Red, _config.Item("AALineWidth").GetValue<Slider>().Value);
                }
                ...
                if (_config.Item("AACircle2").GetValue<Circle>().Active)
                {
                        ...
                        HeroManager.Enemies.FindAll(target => target.IsValidTarget(1175)))
                    {
                        Render.Circle.DrawCircle(
                            target.Position, GetAttackRange(target) + 65,
                            _config.Item("AACircle2").GetValue<Circle>().Color, _config.Item("AALineWidth").GetValue<Slider>().Value);
                    }
                }
                ...
                if (_config.Item("HoldZone").GetValue<Circle>().Active)
                {
                    Render.Circle.DrawCircle(
                        ...
                        _config.Item("HoldZone").GetValue<Circle>().Color, _config.Item("AALineWidth").GetValue<Slider>().Value, true);
                }
                ...
                if (Game.MapId == (GameMapId)11 && _config.Item("wushangdaye").GetValue<bool>())
                {
                    ...
                    Render.Circle.DrawCircle(new Vector3(7461.018f, 3253.575f, 52.57141f), circleRange, System.Drawing.Color.Orange, _config.Item("AALineWidth").GetValue<Slider>().Value); // blue team :red
                    Render.Circle.DrawCircle(new Vector3(3511.601f, 8745.617f, 52.57141f), circleRange, System.Drawing.Color.Orange, _config.Item("AALineWidth").GetValue<Slider>().Value); // blue team :blue
                    Render.Circle.DrawCircle(new Vector3(7462.053f, 2489.813f, 52.57141f), circleRange, System.Drawing.Color.Orange, _config.Item("AALineWidth").GetValue<Slider>().Value); // blue team :golems
                    Render.Circle.DrawCircle(new Vector3(3144.897f, 7106.449f, 51.89026f), circleRange, System.Drawing.Color.Orange, _config.Item("AALineWidth").GetValue<Slider>().Value); // blue team :wolfs
                    Render.Circle.DrawCircle(new Vector3(7770.341f, 5061.238f, 49.26587f), circleRange, System.Drawing.Color.Orange, _config.Item("AALineWidth").GetValue<Slider>().Value); // blue team :wariaths
                    Render.Circle.DrawCircle(new Vector3(10930.93f, 5405.83f, -68.72192f), circleRange, System.Drawing.Color.Red, _config.Item("AALineWidth").GetValue<Slider>().Value); // Dragon
                    Render.Circle.DrawCircle(new Vector3(7326.056f, 11643.01f, 50.21985f), circleRange, System.Drawing.Color.Orange, _config.Item("AALineWidth").GetValue<Slider>().Value); // red team :red
                    Render.Circle.DrawCircle(new Vector3(11417.6f, 6216.028f, 51.00244f), circleRange, System.Drawing.Color.Orange, _config.Item("AALineWidth").GetValue<Slider>().Value); // red team :blue
                    Render.Circle.DrawCircle(new Vector3(7368.408f, 12488.37f, 56.47668f), circleRange, System.Drawing.Color.Orange, _config.Item("AALineWidth").GetValue<Slider>().Value); // red team :golems
                    Render.Circle.DrawCircle(new Vector3(10342.77f, 8896.083f, 51.72742f), circleRange, System.Drawing.Color.Orange, _config.Item("AALineWidth").GetValue<Slider>().Value); // red team :wolfs
                    Render.Circle.DrawCircle(new Vector3(7001.741f, 9915.717f, 54.02466f), circleRange, System.Drawing.Color.Orange, _config.Item("AALineWidth").GetValue<Slider>().Value); // red team :wariaths                    
                }
                ...
                if (补刀小兵.Active)
                {
                    ...
                    foreach (var xMinion in xMinions)
                    {
                        if (Player.CharData.BaseSkinName != "Kalista")
                        {
                            ...
                            {
                                Render.Circle.DrawCircle(xMinion.Position, xMinion.BoundingRadius, 补刀小兵.Color, _config.Item("AALineWidth").GetValue<Slider>().Value);
                            }
                        }
                        else 
                        {
